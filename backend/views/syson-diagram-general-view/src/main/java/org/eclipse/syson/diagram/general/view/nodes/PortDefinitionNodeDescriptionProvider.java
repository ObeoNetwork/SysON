...
/**
 * Used to create the port definition node description.
 *
 * @author arichard
 */
public class PortDefinitionNodeDescriptionProvider extends AbstractNodeDescriptionProvider {

    public static final String NAME = "GV Node PortDefinition";

    public PortDefinitionNodeDescriptionProvider(IColorProvider colorProvider) {
        super(colorProvider);
    }
    ...
    public void link(DiagramDescription diagramDescription, IViewDiagramElementFinder cache) {
        ...
        if (optPartUsageNodeDescription.isPresent()) {
            NodeDescription nodeDescription = optPortDefinitionNodeDescription.get();
