...
/**
 * Used to create the item definition node description.
 *
 * @author arichard
 */
public class ItemDefinitionNodeDescriptionProvider extends AbstractNodeDescriptionProvider {

    public static final String NAME = "GV Node ItemDefinition";

    public ItemDefinitionNodeDescriptionProvider(IColorProvider colorProvider) {
        super(colorProvider);
    }

    @Override
    public NodeDescription create() {
        String domainType = SysMLMetamodelHelper.buildQualifiedName(SysmlPackage.eINSTANCE.getItemDefinition());
    ...
    public void link(DiagramDescription diagramDescription, IViewDiagramElementFinder cache) {
        ...
        if (optPartUsageNodeDescription.isPresent()) {
            NodeDescription nodeDescription = optItemDefinitionNodeDescription.get();
